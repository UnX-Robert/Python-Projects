...
class Game:
    ...
    def __init__(self):
        ...
        self.tk.wm_attributes("-topmost", 1)  # show the window over other windows
...
class Coords:
    ...
    # check if objects cross over each other horizontally
    def within_x(co1, co2):
        if (co2.x1 < co1.x1 < co2.x2) \
                or (co2.x1 < co1.x2 < co2.x2) \
                or (co1.x1 < co2.x1 < co1.x2) \
                or (co2.x2 > co1.x1 > co2.x2):
            return True
        return False

    # check if objects collide vertically
...
platform9 = PlatformSprite(g, PhotoImage(file="platform2.gif"), 45, 60, 66, 10)
